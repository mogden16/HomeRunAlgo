...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--feature-profile", default="pregame_safe_v1", choices=["stable", "pregame_safe_v1", "live", "live_plus", "live_shrunk", "live_shrunk_precise", "live_usable_candidate_v1", "live_usable_candidate_v2", "live_usable_candidate_v3", "live_xstats_v1", "live_bat_tracking_v1", "expanded", "all"], help="Feature profile search space for prepare.")
