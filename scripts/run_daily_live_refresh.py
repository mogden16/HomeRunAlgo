...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--feature-profile", default="live_shrunk_precise", choices=["stable", "live", "live_plus", "live_shrunk", "live_shrunk_precise", "expanded", "all"], help="Feature profile search space.")
